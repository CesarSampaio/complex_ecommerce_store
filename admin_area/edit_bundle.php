...
<i class="fa fa-dashboard"> </i> Painel de Controle / Editar Lote
...
<i class="fa fa-money fa-fw"></i> Editar Lote
...
<label class="control-label" > Lote - Titulo </label>
...
<label class="control-label" > Lote - SEO Descrição </label>
...
<label class="control-label" > Lote - URL </label>
...
<label class="control-label" > Lote - Tabs </label>

<ul class="nav nav-tabs"><!-- nav nav-tabs Starts -->

<li class="active">

<a data-toggle="tab" href="#description"> Lote - Descrição </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Lote - Características </a>

</li>

<li>

<a data-toggle="tab" href="#video"> Som e Video </a>
...
<label class="control-label" > Lote - Peso <small> (KG) </small> </label>
...
<label class=" control-label" > Lote - Preço </label>
...
<label class=" control-label" > Lote - Preço de Oferta </label>
...
<label class="control-label" > Selecione um Tipo de Lote </label>

<select class="form-control" name="product_type"><!-- select manufacturer Starts -->

<?php if($p_type == "physical_product"){ ?>

<option value="physical_product" selected> (Lote de Produtos Físicos) Lote Simples </option>

<option value="digital_product"> (Lotes de Produtos Digitais) Lote por Download  </option>

<?php }elseif($p_type == "digital_product"){ ?>

<option value="physical_product"> (Lotes de Produtos Físicos) Lote Simples </option>

<option value="digital_product" selected> (Lotes de Produtos Digitais) Lote por Download  </option>
...
<label class="control-label" > Selecionar um Fabricante </label>
...
<label class="control-label" > Lote - Imagem 1 </label>
...
<label class="control-label" > Lote - Imagem 2 </label>
...
<label class="control-label" > Lote - Imagem 3 </label>
...
<label class="control-label" > Lote - Palavras Chave </label>
...
<label class="control-label" > Lote - Rotulo </label>
