...
<i class="fa fa-dashboard" ></i> Painel de Controle / Editar Página - Sobre
...
<i class="fa fa-money fa-fw"></i> Editar Página - Sobre
...
<label class="col-md-3 control-label"> Sobre - Cabeçalho: </label>
...
<label class="col-md-3 control-label"> Sobre - Descrição Curta: </label>
...
<label class="col-md-3 control-label"> Sobre - Descrição: </label>
...
echo "<script>alert('Página Sobre foi editada com sucesso')</script>";
