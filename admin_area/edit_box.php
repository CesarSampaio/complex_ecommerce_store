...
?>
    ...
    <div class="row" ><!-- 1 row Starts -->
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            <ol class="breadcrumb" ><!-- breadcrumb Starts -->
                <li class="active">
                    <i class="fa fa-dashboard"></i> Painel de Controle / Editar Box
                </li>
            </ol><!-- breadcrumb Ends -->
        </div><!-- col-lg-12 Ends -->
    </div><!-- 1 row Ends -->
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    <form class="form-horizontal" method="post" action=""><!-- form-horizontal Starts -->
                        ...
                        <div class="form-group"><!-- 2 form-group Starts -->
                            <label class="col-md-3 control-label">Box - Descrição : </label>
                            <div class="col-md-6">
    ...
    <?php
        if(isset($_POST['update'])) {
            ...
            echo "<script>alert('Box Foi editado com sucesso')</script>";
