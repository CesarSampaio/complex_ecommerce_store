...
<a href="#">
Carrinho de Compras - Valor Total: <span class="subtotal-cart-price"><?php total_price(); ?></span>, Total de Items: <?php items(); ?>
</a>
...
<a href="cart.php" class="active"> Carrinho de Compras </a>
