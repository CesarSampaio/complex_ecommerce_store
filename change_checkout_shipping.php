...
<input type="submit" id="paypal-submit" name="submit" value="Continuar com PayPal" class="btn btn-success btn-lg" style="border-radius:0px;" >
...
var confirm_action = confirm("Você realmente deseja pagar por seus produtos por bolet/tranferência bancária.");
