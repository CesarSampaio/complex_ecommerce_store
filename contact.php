...
<span> <?php items(); ?> items no carrinho de compras </span>
...
<label> Selecionar tipo de requisição </label>


<select name="enquiry_type" class="form-control"><!-- select Starts -->

<option> Selecionar tipo de requisição </option>
...
$msg = "Entraremos em contato em breve. Obrigado pelo seu email.";

$from = "sad.ahmed22224@gmail.com";

mail($email,$subject,$msg,$from);

echo "<h2 align='center'>Sua viagem foi enviada com sucesso.</h2>";
