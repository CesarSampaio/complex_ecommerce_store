...
<label class="col-md-5 control-label" >Quantidade </label>
...
<label class="col-md-5 control-label" >Quantidade / Lote </label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_qty" class="form-control" >

<option>Selecione quantidade</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<label class="col-md-5 control-label" >Tamanho / Lote</label>
...
<i class="fa fa-heart" ></i> Adicionar à Lista de Desejos
...
echo "<script>alert('Você precisa se logar para adicionar produtos à lista de desejos')</script>";
...
echo "<script>alert('Produto já está em sua Lista de Desejos')</script>";
...
<h3 class="text-center"> Você também pode gostar desses produtos </h3>
...
<h3 class="text-center"> Produtos / Lote </h3>
