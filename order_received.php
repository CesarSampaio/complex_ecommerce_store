...
<a href="cart.php"> Carinho de Compras </a>

<i class="fa fa-chevron-right"></i>

<a href="checkout.php"> Conferir Pedido </a>

<i class="fa fa-chevron-right"></i>

<a href="#" class="active"> Ordem Completa </a>
...
<h4 class="text-success"> Obrigado, seu Pedido foi recebido. </h4>

<ul class="order-received-list"><!-- ul order-received-list Starts -->

<li> Número do Pedido: <strong>#<?php echo $invoice_no; ?></strong> </li>

<li> Date: <strong><?php echo $order_date; ?></strong> </li>

<li> Método de Pagamento: <strong><?php echo ucwords($payment_method); ?></strong> </li>
...
<a class="text-muted" href="customer/my_account.php?my_orders"> Clique aqui para ir à sua conta </a>
